...
/// <summary>
/// This class handles the placement of objects from the inventory in the AR Scene using both free form and snap mode
/// </summary>
public class PlaceOnDrag : MonoBehaviour
{
    ...
    private PlacedObjectAttributes ownAttributes;
        ...
        /// <summary>
        /// This function handles the object placement if the freeform toggle is off otherwise passes it to FreeFormPlacementHandler
        /// It sends a ray cast out from the camera to get the object it collides with and then based on the type of the
        /// object being placed and the object being collided with it disables or enables placement
        /// </summary>
        ...
        /// <summary>
        /// This function checks for a downward raycast from the object's pivot point and then enables or disables
        /// placement based on the object underneath:
        /// - If the Object is Foundation and object underneath does not have a PlacedObjectAttributes component it
        ///     means that the object is part of the mesh generated by Lightship so the foundation can be placed
        /// - The rest of the checks follow the non-stackable > stackable > foundation rule using the
        ///     ownAttributes.CanPlace function.
        /// The material is then set to green or red depending on whether it's placeable or not
        /// ToDo: Give feedback when the object cannot be placed because it would be obscured by real world objects.
        /// ToDo: For instance we could reduce the opacity of the mesh. Otherwise it looks like the object is not
        /// ToDo: placeable even though it does not collide with anything.
        /// </summary>
        ...
        /// <summary>
        /// This function creates a normal at point of hit and projects the object to be placed with that normal at the
        /// hit point
        /// </summary>
        ...
        /// <summary>
        /// This function is invoked when an inventory item gets selected.
        /// It will initialize the object and then call the placement function.
        /// </summary>
        ...
        /// <summary>
        /// Places _selectedGameObject with a fixed distance from the camera.
        /// The distance increases based on the object category.
        /// ToDo: instead of looking at the category, standardize the object sizes and set the distance based on scale
        /// </summary>
        ...
        /// <summary>
        /// Place the object once done button is clicked and restore the material
        /// Then update biome habitability meter
        /// </summary>
        ...
        /// <summary>
        /// Send the item back to inventory when cancel button is pressed
        /// </summary>
